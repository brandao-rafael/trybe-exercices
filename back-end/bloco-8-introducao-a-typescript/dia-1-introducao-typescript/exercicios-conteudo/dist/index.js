...
// exercices
console.log(`losangleArea ${Ex.losangleArea(32, 18)}`);
console.log(`losangleArea ${Ex.losangleArea(200, 50)}`);
console.log(`losangleArea ${Ex.losangleArea(75, 25)}`);
console.log(`trapezeArea ${Ex.trapezeArea(100, 70, 50)}`);
console.log(`trapezeArea ${Ex.trapezeArea(75, 50, 35)}`);
console.log(`trapezeArea ${Ex.trapezeArea(150, 120, 80)}`);
console.log(`circleArea ${Ex.circleArea(25)}`);
console.log(`circleArea ${Ex.circleArea(100)}`);
console.log(`circleArea ${Ex.circleArea(12.5)}`);
